...
public class ShadersRender
{
    ...
    public static void renderShadowMap(EntityRenderer entityRenderer, int pass, float partialTicks, long finishTimeNano)
    {
        if (Shaders.usedShadowDepthBuffers > 0 && --Shaders.shadowPassCounter <= 0)
        {
            ...
            Shaders.preShadowPassThirdPersonView = minecraft.gameSettings.thirdPersonViewSetting;
            minecraft.gameSettings.thirdPersonViewSetting = 1;
            ...
            minecraft.gameSettings.thirdPersonViewSetting = Shaders.preShadowPassThirdPersonView;
